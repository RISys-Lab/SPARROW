...
from sparrow.model.ddetr import CustomDDETRConfig, CustomDDETRModel
...
def train():
    ...
    # from sparrow.data.datasets.det_data import ClassAgnosticCoCo
    # from sparrow.data.collator import DataCollatorForDetEvalDataset
    #
