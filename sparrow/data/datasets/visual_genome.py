...
from sparrow.data.datasets.flickr import INSTRUCTIONS
from sparrow.data.datasets.det_data import normalize_box_coordinates
from sparrow.constants import DEFAULT_TOKENS, IGNORE_INDEX
from sparrow.data.conversation import conv_templates
