...
class LlavaMetaForCausalLM(ABC):
    ...
    def initialize_vision_tokenizer(self, model_args, num_new_tokens):
        '''
        The purpose of this function is to make the input_embeddings_layer trainable in case we are finetuning the projector layer.
        In original LISA, this is never called in train_ds.py
        
        However we will need to use this is we are finetuning the projector layer.
        '''
