...
class VAL_MevisGCGBaseDataset(Dataset):
    def __init__(self, base_video_dataset_dir = './video_dataset', image_set="valid_u"):
...
class VAL_MevisGCGDataset(Dataset):
    ignore_label = 255
    ...
    def __init__(
        ...
        assert self.image_set in ["valid_u" ], f"invalid image_set:{self.image_set}" #TODO
        
        self.dataset = VAL_MevisGCGBaseDataset(base_video_dataset_dir, image_set)
