...
class VAL_BURST_YTVIS_GCGBaseDataset(torch.utils.data.Dataset):
    def __init__(self, base_video_dataset_dir, image_set="test", max_num_frames=40):
...
class VAL_BURST_YTVIS_GCGDataset(torch.utils.data.Dataset):
    ignore_label = 255
    ...
    def __init__(
        ...
        # self.dataset = VAL_BURST_YTVIS_GCGBaseDataset(base_video_dataset_dir, max_num_frames=5)
        self.dataset = VAL_BURST_YTVIS_GCGBaseDataset(base_video_dataset_dir)
