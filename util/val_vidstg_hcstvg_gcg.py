...
class VAL_VidSTG_HCSTVG_GCGBaseDataset(Dataset):
    def __init__(self, base_video_dataset_dir = './video_dataset', image_set="val", source_dataset="vidstg"):
...
class VAL_VidSTG_HCSTVG_GCGDataset(Dataset):
    ignore_label = 255
    ...
    def __init__(
        ...
        assert self.image_set in ["val" ], f"invalid image_set:{self.image_set}"
        
        self.dataset = VAL_VidSTG_HCSTVG_GCGBaseDataset(base_video_dataset_dir=base_video_dataset_dir, image_set=image_set, source_dataset=source_dataset)
